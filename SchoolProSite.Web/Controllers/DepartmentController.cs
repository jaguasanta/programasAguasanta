...
namespace SchoolProSite.Web.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Details(int id)
        {
            ...
            var modelDepto = new Models.DepartmentModel()
            {
        ...
        public ActionResult Create(Models.DepartmentModel departmentModel)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Models.DepartmentModel departmentModel)
        {
            try
            {
                Department department = new Department()
